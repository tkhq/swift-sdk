...
export async function verifyOtp(
  ...
  const { otpId, otpCode, expirationSeconds } = req.body;
  ...
  return { verificationToken: verifyResponse!.verificationToken };
}

export async function otp(
  req: Request<{}, {}, CompleteOtpParams>
): Promise<CompleteOtpResponse> {
  const { verificationToken, otpType, contact, publicKey, expirationSeconds } =
    req.body;
