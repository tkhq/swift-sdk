...
extension TurnkeyContext {
  ...
  public func fetchWallets() async throws -> [Wallet] {
    ...
    do {
      let resp = try await client.getWallets(
        TGetWalletsBody(organizationId: session.organizationId))
  ...
  public func exportWallet(
    walletId: String, dangerouslyOverrideSignerPublicKey: String? = nil, returnMnemonic: Bool = true
  ) async throws -> String {
