...
public enum Components {
  ...
  public enum Schemas {
    ...
    public struct Activity: Codable, Hashable, Sendable {
      ...
      /// - Remark: Generated from `#/components/schemas/Activity/votesPayload`.
      @frozen public enum votesPayloadPayload: Codable, Hashable, Sendable {
        /// - Remark: Generated from `#/components/schemas/Activity/votesPayload/case1`.
        case Vote(Components.Schemas.Vote)
        /// - Remark: Generated from `#/components/schemas/Activity/votesPayload/case2`.
        case case2(OpenAPIRuntime.OpenAPIValueContainer?)
        public init(from decoder: any Decoder) throws {
          var errors: [any Error] = []
          do {
            self = .Vote(try .init(from: decoder))
            return
          } catch {
            errors.append(error)
          }
      ...
      public typealias votesPayload = [Components.Schemas.Activity.votesPayloadPayload]
      /// A list of objects representing a particular User's approval or rejection of a Consensus request, including all relevant metadata.
      ///
      /// - Remark: Generated from `#/components/schemas/Activity/votes`.
      public var votes: Components.Schemas.Activity.votesPayload
      ...
      public init(
        ...
        votes: Components.Schemas.Activity.votesPayload,
