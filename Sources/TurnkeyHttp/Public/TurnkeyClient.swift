...
public struct TurnkeyClient {
  ...
  internal init(underlyingClient: any APIProtocol) {
    self.underlyingClient = underlyingClient
          ...
          public func getActivity(organizationId: String, activityId: String) async throws -> Operations.GetActivity.Output.Ok {
          ...
          public func getApiKey(organizationId: String, apiKeyId: String) async throws -> Operations.GetApiKey.Output.Ok {
          ...
          public func getApiKeys(organizationId: String, userId: String?) async throws -> Operations.GetApiKeys.Output.Ok {
          ...
          public func getAuthenticator(organizationId: String, authenticatorId: String) async throws -> Operations.GetAuthenticator.Output.Ok {
          ...
          public func getAuthenticators(organizationId: String, userId: String) async throws -> Operations.GetAuthenticators.Output.Ok {
          ...
          public func getOauthProviders(organizationId: String, userId: String?) async throws -> Operations.GetOauthProviders.Output.Ok {
          ...
          public func getOrganizationConfigs(organizationId: String) async throws -> Operations.GetOrganizationConfigs.Output.Ok {
          ...
          public func getPolicy(organizationId: String, policyId: String) async throws -> Operations.GetPolicy.Output.Ok {
          ...
          public func getPrivateKey(organizationId: String, privateKeyId: String) async throws -> Operations.GetPrivateKey.Output.Ok {
          ...
          public func getUser(organizationId: String, userId: String) async throws -> Operations.GetUser.Output.Ok {
          ...
          public func getWallet(organizationId: String, walletId: String) async throws -> Operations.GetWallet.Output.Ok {
          ...
          public func getWalletAccount(organizationId: String, walletId: String, address: String?, path: String?) async throws -> Operations.GetWalletAccount.Output.Ok {
          ...
          public func getActivities(organizationId: String, filterByStatus: [Components.Schemas.ActivityStatus]?, paginationOptions: Components.Schemas.Pagination?, filterByType: [Components.Schemas.ActivityType]?) async throws -> Operations.GetActivities.Output.Ok {

          // Create the GetActivitiesRequest
          let getActivitiesRequest = Components.Schemas.GetActivitiesRequest(
              organizationId: organizationId, filterByStatus: filterByStatus, paginationOptions: paginationOptions, filterByType: filterByType
          )
          ...
          public func listPrivateKeyTags(organizationId: String) async throws -> Operations.ListPrivateKeyTags.Output.Ok {
          ...
          public func getPrivateKeys(organizationId: String) async throws -> Operations.GetPrivateKeys.Output.Ok {
          ...
          public func getSubOrgIds(organizationId: String, filterType: String?, filterValue: String?, paginationOptions: Components.Schemas.Pagination?) async throws -> Operations.GetSubOrgIds.Output.Ok {

          // Create the GetSubOrgIdsRequest
          let getSubOrgIdsRequest = Components.Schemas.GetSubOrgIdsRequest(
              organizationId: organizationId, filterType: filterType, filterValue: filterValue, paginationOptions: paginationOptions
          )
          ...
          public func getVerifiedSubOrgIds(organizationId: String, filterType: String?, filterValue: String?, paginationOptions: Components.Schemas.Pagination?) async throws -> Operations.GetVerifiedSubOrgIds.Output.Ok {
          ...
          public func getWalletAccounts(organizationId: String, walletId: String, paginationOptions: Components.Schemas.Pagination?) async throws -> Operations.GetWalletAccounts.Output.Ok {
    ...
    public func approveActivity(
            ...
            , 
                fingerprint: String) async throws -> Operations.ApproveActivity.Output {
    ...
    public func createApiKeys(
            organizationId: String
            , 
                apiKeys: [Components.Schemas.ApiKeyParamsV2], userId: String) async throws -> Operations.CreateApiKeys.Output {
    ...
    public func createAuthenticators(
            organizationId: String
            , 
                authenticators: [Components.Schemas.AuthenticatorParamsV2], userId: String) async throws -> Operations.CreateAuthenticators.Output {
    ...
    public func createInvitations(
            organizationId: String
            , 
                invitations: [Components.Schemas.InvitationParams]) async throws -> Operations.CreateInvitations.Output {
    ...
    public func createOauthProviders(
            organizationId: String
            , 
                userId: String, oauthProviders: [Components.Schemas.OauthProviderParams]) async throws -> Operations.CreateOauthProviders.Output {
    ...
    public func createPolicies(
            organizationId: String
            , 
                policies: [Components.Schemas.CreatePolicyIntentV3]) async throws -> Operations.CreatePolicies.Output {
    ...
    public func createPolicy(
            organizationId: String
            , 
                policyName: String, effect: Components.Schemas.Effect, condition: String?, consensus: String?, notes: String?) async throws -> Operations.CreatePolicy.Output {

        // Create the CreatePolicyIntentV3
        let createPolicyIntent = Components.Schemas.CreatePolicyIntentV3(
        policyName: policyName, effect: effect, condition: condition, consensus: consensus, notes: notes)
    ...
    public func createPrivateKeyTag(
            organizationId: String
            , 
                privateKeyTagName: String, privateKeyIds: [String]) async throws -> Operations.CreatePrivateKeyTag.Output {
    ...
    public func createPrivateKeys(
            organizationId: String
            , 
                privateKeys: [Components.Schemas.PrivateKeyParams]) async throws -> Operations.CreatePrivateKeys.Output {
    ...
    public func createReadWriteSession(
            organizationId: String
            , 
                targetPublicKey: String, userId: String?, apiKeyName: String?, expirationSeconds: String?, invalidateExisting: Bool?) async throws -> Operations.CreateReadWriteSession.Output {
        ...
        targetPublicKey: targetPublicKey, userId: userId, apiKeyName: apiKeyName, expirationSeconds: expirationSeconds, invalidateExisting: invalidateExisting)
    ...
    public func createSubOrganization(
            organizationId: String
            , 
                subOrganizationName: String, rootUsers: [Components.Schemas.RootUserParamsV4], rootQuorumThreshold: Int32, wallet: Components.Schemas.WalletParams?, disableEmailRecovery: Bool?, disableEmailAuth: Bool?, disableSmsAuth: Bool?, disableOtpEmailAuth: Bool?) async throws -> Operations.CreateSubOrganization.Output {

        // Create the CreateSubOrganizationIntentV7
        let createSubOrganizationIntent = Components.Schemas.CreateSubOrganizationIntentV7(
        subOrganizationName: subOrganizationName, rootUsers: rootUsers, rootQuorumThreshold: rootQuorumThreshold, wallet: wallet, disableEmailRecovery: disableEmailRecovery, disableEmailAuth: disableEmailAuth, disableSmsAuth: disableSmsAuth, disableOtpEmailAuth: disableOtpEmailAuth)
    ...
    public func createUserTag(
            organizationId: String
            , 
                userTagName: String, userIds: [String]) async throws -> Operations.CreateUserTag.Output {
    ...
    public func createUsers(
            organizationId: String
            , 
                users: [Components.Schemas.UserParamsV3]) async throws -> Operations.CreateUsers.Output {
    ...
    public func createWallet(
            organizationId: String
            , 
                walletName: String, accounts: [Components.Schemas.WalletAccountParams], mnemonicLength: Int32?) async throws -> Operations.CreateWallet.Output {
    ...
    public func createWalletAccounts(
            organizationId: String
            , 
                walletId: String, accounts: [Components.Schemas.WalletAccountParams]) async throws -> Operations.CreateWalletAccounts.Output {
    ...
    public func deleteApiKeys(
            organizationId: String
            , 
                userId: String, apiKeyIds: [String]) async throws -> Operations.DeleteApiKeys.Output {
    ...
    public func deleteAuthenticators(
            organizationId: String
            , 
                userId: String, authenticatorIds: [String]) async throws -> Operations.DeleteAuthenticators.Output {
    ...
    public func deleteInvitation(
            organizationId: String
            , 
                invitationId: String) async throws -> Operations.DeleteInvitation.Output {
    ...
    public func deleteOauthProviders(
            organizationId: String
            , 
                userId: String, providerIds: [String]) async throws -> Operations.DeleteOauthProviders.Output {
    ...
    public func deletePolicy(
            organizationId: String
            , 
                policyId: String) async throws -> Operations.DeletePolicy.Output {
    ...
    public func deletePrivateKeyTags(
            organizationId: String
            , 
                privateKeyTagIds: [String]) async throws -> Operations.DeletePrivateKeyTags.Output {
    ...
    public func deletePrivateKeys(
            organizationId: String
            , 
                privateKeyIds: [String], deleteWithoutExport: Bool?) async throws -> Operations.DeletePrivateKeys.Output {
    ...
    public func deleteSubOrganization(
            organizationId: String
            , 
                deleteWithoutExport: Bool?) async throws -> Operations.DeleteSubOrganization.Output {
    ...
    public func deleteUserTags(
            organizationId: String
            , 
                userTagIds: [String]) async throws -> Operations.DeleteUserTags.Output {
    ...
    public func deleteUsers(
            organizationId: String
            , 
                userIds: [String]) async throws -> Operations.DeleteUsers.Output {
    ...
    public func deleteWallets(
            organizationId: String
            , 
                walletIds: [String], deleteWithoutExport: Bool?) async throws -> Operations.DeleteWallets.Output {
    ...
    public func emailAuth(
            organizationId: String
            , 
                email: String, targetPublicKey: String, apiKeyName: String?, expirationSeconds: String?, emailCustomization: Components.Schemas.EmailCustomizationParams?, invalidateExisting: Bool?, sendFromEmailAddress: String?, sendFromEmailSenderName: String?, replyToEmailAddress: String?) async throws -> Operations.EmailAuth.Output {
    ...
    public func exportPrivateKey(
            organizationId: String
            , 
                privateKeyId: String, targetPublicKey: String) async throws -> Operations.ExportPrivateKey.Output {
    ...
    public func exportWallet(
            organizationId: String
            , 
                walletId: String, targetPublicKey: String, language: Components.Schemas.MnemonicLanguage?) async throws -> Operations.ExportWallet.Output {
    ...
    public func exportWalletAccount(
            organizationId: String
            , 
                address: String, targetPublicKey: String) async throws -> Operations.ExportWalletAccount.Output {
    ...
    public func importPrivateKey(
            organizationId: String
            , 
                userId: String, privateKeyName: String, encryptedBundle: String, curve: Components.Schemas.Curve, addressFormats: [Components.Schemas.AddressFormat]) async throws -> Operations.ImportPrivateKey.Output {

        // Create the ImportPrivateKeyIntent
        let importPrivateKeyIntent = Components.Schemas.ImportPrivateKeyIntent(
        userId: userId, privateKeyName: privateKeyName, encryptedBundle: encryptedBundle, curve: curve, addressFormats: addressFormats)
    ...
    public func importWallet(
            organizationId: String
            , 
                userId: String, walletName: String, encryptedBundle: String, accounts: [Components.Schemas.WalletAccountParams]) async throws -> Operations.ImportWallet.Output {
    ...
    public func initImportPrivateKey(
            organizationId: String
            , 
                userId: String) async throws -> Operations.InitImportPrivateKey.Output {
    ...
    public func initImportWallet(
            organizationId: String
            , 
                userId: String) async throws -> Operations.InitImportWallet.Output {
    ...
    public func initOtpAuth(
            organizationId: String
            , 
                otpType: String, contact: String, otpLength: Int32?, emailCustomization: Components.Schemas.EmailCustomizationParams?, smsCustomization: Components.Schemas.SmsCustomizationParams?, userIdentifier: String?, sendFromEmailAddress: String?, alphanumeric: Bool?, sendFromEmailSenderName: String?, replyToEmailAddress: String?) async throws -> Operations.InitOtpAuth.Output {
    ...
    public func initUserEmailRecovery(
            organizationId: String
            , 
                email: String, targetPublicKey: String, expirationSeconds: String?, emailCustomization: Components.Schemas.EmailCustomizationParams?) async throws -> Operations.InitUserEmailRecovery.Output {

        // Create the InitUserEmailRecoveryIntent
        let initUserEmailRecoveryIntent = Components.Schemas.InitUserEmailRecoveryIntent(
        email: email, targetPublicKey: targetPublicKey, expirationSeconds: expirationSeconds, emailCustomization: emailCustomization)
    ...
    public func oauth(
            organizationId: String
            , 
                oidcToken: String, targetPublicKey: String, apiKeyName: String?, expirationSeconds: String?, invalidateExisting: Bool?) async throws -> Operations.Oauth.Output {

        // Create the OauthIntent
        let oauthIntent = Components.Schemas.OauthIntent(
        oidcToken: oidcToken, targetPublicKey: targetPublicKey, apiKeyName: apiKeyName, expirationSeconds: expirationSeconds, invalidateExisting: invalidateExisting)
    ...
    public func oauthLogin(
            organizationId: String
            , 
                oidcToken: String, publicKey: String, expirationSeconds: String?, invalidateExisting: Bool?) async throws -> Operations.OauthLogin.Output {

        // Create the OauthLoginIntent
        let oauthLoginIntent = Components.Schemas.OauthLoginIntent(
        oidcToken: oidcToken, publicKey: publicKey, expirationSeconds: expirationSeconds, invalidateExisting: invalidateExisting)
    ...
    public func otpAuth(
            organizationId: String
            , 
                otpId: String, otpCode: String, targetPublicKey: String, apiKeyName: String?, expirationSeconds: String?, invalidateExisting: Bool?) async throws -> Operations.OtpAuth.Output {

        // Create the OtpAuthIntent
        let otpAuthIntent = Components.Schemas.OtpAuthIntent(
        otpId: otpId, otpCode: otpCode, targetPublicKey: targetPublicKey, apiKeyName: apiKeyName, expirationSeconds: expirationSeconds, invalidateExisting: invalidateExisting)
    ...
    public func otpLogin(
            organizationId: String
            , 
                verificationToken: String, publicKey: String, expirationSeconds: String?, invalidateExisting: Bool?) async throws -> Operations.OtpLogin.Output {

        // Create the OtpLoginIntent
        let otpLoginIntent = Components.Schemas.OtpLoginIntent(
        verificationToken: verificationToken, publicKey: publicKey, expirationSeconds: expirationSeconds, invalidateExisting: invalidateExisting)
    ...
    public func recoverUser(
            organizationId: String
            , 
                authenticator: Components.Schemas.AuthenticatorParamsV2, userId: String) async throws -> Operations.RecoverUser.Output {
    ...
    public func rejectActivity(
            organizationId: String
            , 
                fingerprint: String) async throws -> Operations.RejectActivity.Output {
    ...
    public func removeOrganizationFeature(
            organizationId: String
            , 
                name: Components.Schemas.FeatureName) async throws -> Operations.RemoveOrganizationFeature.Output {
    ...
    public func setOrganizationFeature(
            organizationId: String
            , 
                name: Components.Schemas.FeatureName, value: String) async throws -> Operations.SetOrganizationFeature.Output {
    ...
    public func signRawPayload(
            organizationId: String
            , 
                signWith: String, payload: String, encoding: Components.Schemas.PayloadEncoding, hashFunction: Components.Schemas.HashFunction) async throws -> Operations.SignRawPayload.Output {
    ...
    public func signRawPayloads(
            organizationId: String
            , 
                signWith: String, payloads: [String], encoding: Components.Schemas.PayloadEncoding, hashFunction: Components.Schemas.HashFunction) async throws -> Operations.SignRawPayloads.Output {
    ...
    public func signTransaction(
            organizationId: String
            , 
                signWith: String, unsignedTransaction: String, _type: Components.Schemas.TransactionType) async throws -> Operations.SignTransaction.Output {
    ...
    public func stampLogin(
            organizationId: String
            , 
                publicKey: String, expirationSeconds: String?, invalidateExisting: Bool?) async throws -> Operations.StampLogin.Output {

        // Create the StampLoginIntent
        let stampLoginIntent = Components.Schemas.StampLoginIntent(
        publicKey: publicKey, expirationSeconds: expirationSeconds, invalidateExisting: invalidateExisting)
    ...
    public func updatePolicy(
            organizationId: String
            , 
                policyId: String, policyName: String?, policyEffect: Components.Schemas.Effect?, policyCondition: String?, policyConsensus: String?, policyNotes: String?) async throws -> Operations.UpdatePolicy.Output {

        // Create the UpdatePolicyIntentV2
        let updatePolicyIntent = Components.Schemas.UpdatePolicyIntentV2(
        policyId: policyId, policyName: policyName, policyEffect: policyEffect, policyCondition: policyCondition, policyConsensus: policyConsensus, policyNotes: policyNotes)
    ...
    public func updatePrivateKeyTag(
            organizationId: String
            , 
                privateKeyTagId: String, newPrivateKeyTagName: String?, addPrivateKeyIds: [String], removePrivateKeyIds: [String]) async throws -> Operations.UpdatePrivateKeyTag.Output {

        // Create the UpdatePrivateKeyTagIntent
        let updatePrivateKeyTagIntent = Components.Schemas.UpdatePrivateKeyTagIntent(
        privateKeyTagId: privateKeyTagId, newPrivateKeyTagName: newPrivateKeyTagName, addPrivateKeyIds: addPrivateKeyIds, removePrivateKeyIds: removePrivateKeyIds)
    ...
    public func updateRootQuorum(
            organizationId: String
            , 
                threshold: Int32, userIds: [String]) async throws -> Operations.UpdateRootQuorum.Output {
    ...
    public func updateUser(
            organizationId: String
            , 
                userId: String, userName: String?, userEmail: String?, userTagIds: [String]?, userPhoneNumber: String?) async throws -> Operations.UpdateUser.Output {

        // Create the UpdateUserIntent
        let updateUserIntent = Components.Schemas.UpdateUserIntent(
        userId: userId, userName: userName, userEmail: userEmail, userTagIds: userTagIds, userPhoneNumber: userPhoneNumber)
    ...
    public func updateUserTag(
            organizationId: String
            , 
                userTagId: String, newUserTagName: String?, addUserIds: [String], removeUserIds: [String]) async throws -> Operations.UpdateUserTag.Output {

        // Create the UpdateUserTagIntent
        let updateUserTagIntent = Components.Schemas.UpdateUserTagIntent(
        userTagId: userTagId, newUserTagName: newUserTagName, addUserIds: addUserIds, removeUserIds: removeUserIds)
    ...
    public func updateWallet(
            organizationId: String
            , 
                walletId: String, walletName: String?) async throws -> Operations.UpdateWallet.Output {
    ...
    public func verifyOtp(
            organizationId: String
            , 
                otpId: String, otpCode: String, expirationSeconds: String?) async throws -> Operations.VerifyOtp.Output {
