...
public enum v1ActivityType: String, Codable, Sendable {
    ...
    case activity_type_create_smart_contract_interface = "ACTIVITY_TYPE_CREATE_SMART_CONTRACT_INTERFACE"
    case activity_type_delete_smart_contract_interface = "ACTIVITY_TYPE_DELETE_SMART_CONTRACT_INTERFACE"
...
public struct v1AppProof: Codable, Sendable {
    ...
    public let scheme: v1SignatureScheme
...
public struct v1EmailAuthRequest: Codable, Sendable {
    /// Unique identifier for a given Organization.
    public let organizationId: String
    public let parameters: v1EmailAuthIntentV2
    /// Timestamp (in milliseconds) of the request, used to verify liveness of user requests.
    public let timestampMs: String
    public let type: String
...
public enum v1FiatOnRampPaymentMethod: String, Codable, Sendable {
    case fiat_on_ramp_payment_method_credit_debit_card = "FIAT_ON_RAMP_PAYMENT_METHOD_CREDIT_DEBIT_CARD"
    case fiat_on_ramp_payment_method_apple_pay = "FIAT_ON_RAMP_PAYMENT_METHOD_APPLE_PAY"
    case fiat_on_ramp_payment_method_gbp_bank_transfer = "FIAT_ON_RAMP_PAYMENT_METHOD_GBP_BANK_TRANSFER"
    case fiat_on_ramp_payment_method_gbp_open_banking_payment = "FIAT_ON_RAMP_PAYMENT_METHOD_GBP_OPEN_BANKING_PAYMENT"
    case fiat_on_ramp_payment_method_google_pay = "FIAT_ON_RAMP_PAYMENT_METHOD_GOOGLE_PAY"
    case fiat_on_ramp_payment_method_sepa_bank_transfer = "FIAT_ON_RAMP_PAYMENT_METHOD_SEPA_BANK_TRANSFER"
    case fiat_on_ramp_payment_method_pix_instant_payment = "FIAT_ON_RAMP_PAYMENT_METHOD_PIX_INSTANT_PAYMENT"
...
public struct v1GetSmartContractInterfaceResponse: Codable, Sendable {
    ...
    public let smartContractInterface: v1SmartContractInterface
...
public struct v1GetSmartContractInterfacesResponse: Codable, Sendable {
    ...
    public let smartContractInterfaces: [v1SmartContractInterface]
...
public struct v1InitOtpAuthRequest: Codable, Sendable {
    /// Unique identifier for a given Organization.
    public let organizationId: String
    public let parameters: v1InitOtpAuthIntentV2
    /// Timestamp (in milliseconds) of the request, used to verify liveness of user requests.
    public let timestampMs: String
    public let type: String
...
public struct v1InitOtpRequest: Codable, Sendable {
    /// Unique identifier for a given Organization.
    public let organizationId: String
    public let parameters: v1InitOtpIntent
    /// Timestamp (in milliseconds) of the request, used to verify liveness of user requests.
    public let timestampMs: String
    public let type: String
...
public struct v1InitUserEmailRecoveryRequest: Codable, Sendable {
    /// Unique identifier for a given Organization.
    public let organizationId: String
    public let parameters: v1InitUserEmailRecoveryIntent
    /// Timestamp (in milliseconds) of the request, used to verify liveness of user requests.
    public let timestampMs: String
    public let type: String
...
public enum v1SignatureScheme: String, Codable, Sendable {
...
public struct v1SmartContractInterface: Codable, Sendable {
    public let createdAt: externaldatav1Timestamp
