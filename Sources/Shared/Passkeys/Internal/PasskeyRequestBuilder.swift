...
final class PasskeyRequestBuilder {
    ...
    func handleRegistrationResult(_ credential: ASAuthorizationPlatformPublicKeyCredentialRegistration) throws -> PasskeyRegistrationResult {
    ...
    func handleAssertionResult(_ assertion: ASAuthorizationPlatformPublicKeyCredentialAssertion) -> AssertionResult {
