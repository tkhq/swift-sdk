...
struct DashboardView: View {
        ...
        ZStack {
            VStack(spacing: 0) {
                ...
                WalletCardView(
                    ...
                    address: "0xE619E93b05f6C2B3f8D1Ff87CB8e",
                    balanceUSD: "$0.00",
                    balanceETH: "0 ETH",
            ...
            OverlaySheet(isShowing: $showExportWalletSheet) {
                ExportWalletSheet(
                    ...
                    seedPhrase: "brain mother fury sister chef country case trip train provide split frost"
                )
            }
        }
    }
    ...
    private func handleExportPressed() {
        runAfterClosingMenus {
            withAnimation {
    ...
    private func handleSignMessagePressed() {
        runAfterClosingMenus {
            coordinator.push(MainRoute.signMessage)
        }
    }
